...
class OfficeController extends Controller
{
    ...
    */
    ...
    public function actionHome($id=false)
    {
        ...
        // explode them because they are saved in an comma delimited string
        $working_days = $model->holiday;
        $working_days_array=explode(",", $working_days);
        ...
        $skills_timetable_grouped_by_skid= $modelSkillstimetable->findByUserIdAndOfficeIdAndGropupedBySkid();
